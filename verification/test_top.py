...
#the instruction through this testbench and fetching from the instruction memory.
async def adder_randomized_test(dut):
    """Test for adding 2 random numbers, ignoring overflow cases"""
